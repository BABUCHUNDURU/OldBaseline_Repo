...
ISIR Field for Correction: STUDENTSGRANTSCHOLARSHIPAID

Filename: IsirDiscrepancyEvaluationSTUDENTSGRANTSCHOLARSHIPAID.groovy
...
String isirFieldValueForCorrection = isirRecord.getIsirFieldValue("STUDENTSGRANTSCHOLARSHIPAID");

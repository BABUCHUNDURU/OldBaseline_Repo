...
ISIR Field for Correction: PARENTSCHILDSUPPORTPAID

Filename: IsirDiscrepancyEvaluationPARENTSCHILDSUPPORTPAID.groovy
...
String isirFieldValueForCorrection = isirRecord.getIsirFieldValue("PARENTSCHILDSUPPORTPAID");
